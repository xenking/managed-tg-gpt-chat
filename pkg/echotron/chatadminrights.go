...
func (a API) SetMyDefaultAdministratorRights(ctx context.Context, opts *SetMyDefaultAdministratorRightsOptions) (res APIResponseBool, err error) {
	return res, a.client.get(ctx, a.base, "setMyDefaultAdministratorRights", urlValues(opts), &res)
}

// GetMyDefaultAdministratorRights is used to get the current default administrator rights of the bot.
func (a API) GetMyDefaultAdministratorRights(ctx context.Context, opts *GetMyDefaultAdministratorRightsOptions) (res APIResponseChatAdministratorRights, err error) {
	return res, a.client.get(ctx, a.base, "getMyDefaultAdministratorRights", urlValues(opts), &res)
}
