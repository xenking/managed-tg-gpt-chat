...
func (a API) AnswerWebAppQuery(ctx context.Context, webAppQueryID string, result InlineQueryResult) (res APIResponseSentWebAppMessage, err error) {
	...
	return res, a.client.get(ctx, a.base, "answerWebAppQuery", vals, &res)
}
