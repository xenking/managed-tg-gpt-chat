...
func (a API) SetPassportDataErrors(ctx context.Context, userID int64, errors []PassportElementError) (res APIResponseBool, err error) {
	...
	return res, a.client.get(ctx, a.base, "setPassportDataErrors", vals, &res)
}
