...
func (a API) SetChatMenuButton(ctx context.Context, opts *SetChatMenuButtonOptions) (res APIResponseBool, err error) {
	return res, a.client.get(ctx, a.base, "setChatMenuButton", urlValues(opts), &res)
}

// GetChatMenuButton is used to get the current value of the bot's menu button in a private chat, or the default menu button.
func (a API) GetChatMenuButton(ctx context.Context, opts *GetChatMenuButtonOptions) (res APIResponseMenuButton, err error) {
	return res, a.client.get(ctx, a.base, "getChatMenuButton", urlValues(opts), &res)
}
